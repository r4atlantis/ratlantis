...
* initial classification of species into focal groups based on model needs
  * this may be assisted using the create_functional_groups code below, which 
...
* reiterate this process (create groups, check) until you are pleased

One of the major (under development) benefits of the ratlanis package will be the 
...
vertebrate).  ratlantis deals with this by asking how many cohorts you want to include 
for a species and then attempting to classify it into the right Atlantis group for you.
...
These respresent the detrital and bacterial food chain.  
